    ...
    <div>
      ...
      <div className='container d-flex' style={{ marginTop: "25px" }}>
        <form className='border p-4 rounded shadow' required>
          <h6>Pay with Card</h6>
          <br />
          <label htmlFor="w-100">Email:</label>
          ...
          <div className="d-flex flex-row mb-3 align-items-center">
            ...
            <div className="d-flex flex-row ml-2">
              <img src="https://1000logos.net/wp-content/uploads/2021/11/VISA-logo.png" width="40" className="ml-2" alt="visa-logo"/>
              <img src="https://download.logo.wine/logo/Mastercard/Mastercard-Logo.wine.png" width="40" className="ml-2" alt="master-card"/>
              <img src="https://1000logos.net/wp-content/uploads/2016/10/American-Express-Color.png" width="40" className="ml-2" alt='american-logo' />
            </div>
          </div>
